...
{
    private int vidas = 3;
    // nivelPiso = -3.55f; // Este valor representa el nivel del piso para el personaje
    float nivelTecho = 7.13f; // Este valor representa el nivel del piso para el personaje
    ...
    // Este valor representa el límite izquierdo de la cámara para el personaje
    ...
    void Start()
    {
        // Personaje siempre inicia en la posición (-3.759, 3.36)
        gameObject.transform.position = new Vector3(-3.759f,nivelTecho,0);
        Debug.Log("INIT");
    }
